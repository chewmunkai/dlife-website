...
export const SOLUTIONS_E2: Record<string, SolutionE2> = {
  "protecting-your-family": {
    ...
    moments: [
      { src: "/media/img/fam-newborn.jpg", alt: "Parents holding their baby up" },
      { src: "/media/img/fam-newhome.jpg", alt: "A couple carrying boxes into a new home" },
      { src: "/media/img/fam-generations.jpg", alt: "A grandmother helping a child with homework" },
      { src: "/media/img/fam-support.jpg", alt: "Two friends talking on a sofa" },
      { src: "/media/img/fam-oldpolicy.jpg", alt: "A stack of paper files on a desk" },
    ],
  ...
  "protecting-your-income": {
    ...
    moments: [
      ...
      { src: "/media/img/inc-couplebudget.jpg", alt: "A couple going through their finances at a laptop" },
  ...
  "medical-health-preparation": {
    ...
    moments: [
      { src: "/media/img/med-limits.jpg", alt: "A man reading paperwork beside a laptop" },
      { src: "/media/img/med-excess.jpg", alt: "Paying by card on a phone" },
      { src: "/media/img/med-hospital.jpg", alt: "Staff talking in a hospital corridor" },
      { src: "/media/img/med-jobchange.jpg", alt: "A woman thinking at her desk" },
      { src: "/media/img/med-condition.jpg", alt: "A doctor at a consultation desk" },
    ],
  ...
  "planning-for-your-future": {
    ...
    moments: [
      ...
      { src: "/media/img/fut-care.jpg", alt: "An older man reading outdoors" },
      { src: "/media/img/fut-inflation.jpg", alt: "A woman shopping in a supermarket aisle" },
      { src: "/media/img/fut-education.jpg", alt: "A student studying in a library" },
      { src: "/media/img/fut-toolate.jpg", alt: "A woman with a cup of tea looking out of a window" },
    ],
  ...
  "wealth-legacy": {
    ...
    moments: [
      { src: "/media/img/leg-will.jpg", alt: "A couple signing paperwork with an adviser" },
      { src: "/media/img/leg-siblings.jpg", alt: "Siblings together at home" },
      { src: "/media/img/leg-business.jpg", alt: "Vendors and customers at a market stall" },
      { src: "/media/img/leg-dependant.jpg", alt: "Older friends talking together at home" },
      { src: "/media/img/leg-records.jpg", alt: "A woman holding a folder of documents" },
    ],
