...
export const SOLUTIONS_E2: Record<string, SolutionE2> = {
  "protecting-your-family": {
    ...
    moments: [
      ...
      { src: "/media/img/need-planning.jpg", alt: "A woman in the kitchen of a new home" },
      { src: "/media/img/need-family-malaysia.jpg", alt: "Three generations of a family sharing a meal" },
      { src: "/media/img/policy-review.jpg", alt: "Two people in conversation beside a window" },
  ...
  "protecting-your-income": {
    ...
    moments: [
      { src: "/media/img/need-income-malaysia.jpg", alt: "A couple working through figures at a laptop" },
      { src: "/media/img/path-review.jpg", alt: "A man reading through paperwork at a desk" },
      { src: "/media/img/hero.jpg", alt: "A family sharing a meal at home" },
  ...
  "medical-health-preparation": {
    ...
    moments: [
      { src: "/media/img/path-review.jpg", alt: "A man reading through paperwork at a desk" },
      { src: "/media/img/need-income-malaysia.jpg", alt: "A couple working through figures at a laptop" },
      { src: "/media/img/need-health-malaysia.jpg", alt: "Two family members in a consultation with an advisor" },
  ...
  "wealth-legacy": {
    ...
    moments: [
      ...
      { src: "/media/img/need-family-malaysia.jpg", alt: "Three generations of a family sharing a meal" },
      { src: "/media/img/need-legacy.jpg", alt: "The reception area of an office" },
      { src: "/media/img/policy-review.jpg", alt: "Two people in conversation beside a window" },
      { src: "/media/img/path-review.jpg", alt: "A man reading through paperwork at a desk" },
    ],
