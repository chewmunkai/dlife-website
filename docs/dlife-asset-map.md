...
## Generated photography — T02–T06, T08 (14 Sep 2026)

Eleven purpose-made scenes. Generated by the client in ChatGPT from the prompt
pack in `docs/dlife-photo-prompts-2026-09.md`; delivered as 1536x1024 PNG,
installed as JPEG q82 progressive (21 MB of PNG → 2 MB of JPEG). Fictional
people, not D'Life clients or staff.

The Drive route was closed, not skipped: "Website (Group Photo)" was re-read on
14 Sep and holds **22 files, all group or event photography of the agency's own
people** — no family at home, no couple moving house, no ageing parent, no
advisor with a document. (It held 44 when this document was first written; the
client changed it on 31 Aug.)

| File | From | Where | Crop, measured |
|---|---|---|---|
| `contact-hero.jpg` | T02 | Contact → hero | 1080/842 · loses 14.5% width · both subjects whole |
| `family-hero.jpg` | T03a | Protecting your family → hero | 1080/842 · loses 14.5% width · all four whole |
| `future-hero.jpg` | T03b | Planning for your future → hero | 1080/842 · loses 14.5% width · both whole |
| `future-05-start.jpg` | T04 | Planning → card 05 | 16:10 · loses 6.3% height |
| `family-01-newborn.jpg` | T05-01 | Protecting your family → card 01 | 16:10 · loses 6.3% height |
| `family-02-mortgage.jpg` | T05-02 | … card 02 | 16:10 · loses 6.3% height |
| `family-03-sandwich.jpg` | T05-03 | … card 03 | 16:10 · loses 6.3% height |
| `family-04-bereaved-friend.jpg` | T06-04 * | … card 04 | 16:10 · loses 6.3% height |
| `family-05-old-policy.jpg` | T05-05 | … card 05 | 16:10 · loses 6.3% height |
| `closing-next-step.jpg` | T06 | Next-step card, all 10 pages | see the frame note below |
| `policy-schedule-card.jpg` | T08 | “How to read your own policy schedule” card | 3:2 into 3:2 — **0% crop** |

\* `T06-04` is the client's own filename slip — it is the T05 card 04 tiffin
scene. Verified by eye against the brief before mapping, not assumed.

**Every crop above was masked and looked at, not just measured.** Percentages
triage; only the mask decides. At 375, 1280 and 1440 no person is lost from any
of these except the closing band, below.

### The closing band's frame cannot be satisfied by any one photograph

`.close-card`'s picture is a full-bleed ground whose frame is the card, and the
card's height is driven by its own stacked copy. Measured:
...
No single ratio survives 0.54 and 3.14. This is a property of the block, **not
of the new photograph**: the outgoing `hero.jpg` (1.25) lost 56.5% of its width
at 375 too. At 375 three of the seven people fall outside the frame.

What was done about it: `object-position: 100% 50%`. The two axes act
independently here — above ~640px the frame is wider than the picture so the
crop is on the height and X is inert, while on a phone the crop moves to the
width and X decides who survives. 100% keeps four people **whole** rather than
bisecting two, and puts them under the thin end of the scrim, which is the only
part of this picture that is actually visible.

**The real fix is structural and out of scope for this round:** stop the
picture being a full-card background on a phone. Worth putting to the client as
its own decision, since it affects all ten next-step cards whatever photograph
they carry.
...
band the type occupies: **14.7:1 on the mean, 13.8:1 against the 95th-percentile
brightest pixel**. AA wants 4.5:1. The outgoing image measured 9.9:1, so the
darker exposure the brief asked for improved it. Re-run this if the picture
changes again.
