...
**Q1. We merged the "Development Pillars" section into "Health · Wealth · Leadership".**
Your document lists both the three-pillar line and a four-pillar breakdown.
On the page they appeared back to back and three of the four repeated the
same text, so the page said everything twice. The three-pillar section keeps
...
**Q4. Two credential items are deliberately not on the website.**
"Travelled to more than 45 countries" and "Numerous Six-Figure Income
...
## 2 · For transparency (no action needed)

- **DVA — nothing was dropped.** Your document's eleven member gains all
  appear: six as "The work of the circle" (leadership, communication,
  personal branding, financial literacy, mentorship, public speaking) and
  five inside "The shape of a year" (networking, team building, charity and
  volunteer projects, personal development programmes, cross-agency
  collaboration). All nine core activities appear in the same calendar.
- The line "Most conversations with us don't end in a decision…" now appears
  only on client-facing pages, not on every page.
- The small fact-strips were reworded to sound spoken rather than legal
  ("A conversation, not a pitch · Costs you nothing · About an hour of your
  time").
- Duplicate sentences that appeared twice on the same page were reduced to
  once (Existing Policy Support, Careers, About, DVA, and one photo caption
  on the family page).
- The careers page now links to Advisor Stories, as the guide's career
  journey describes.
- Sharon's four focus areas (mindset, personality, wealth, quality of life)
  were added to her biography as a sentence.

---

## 3 · Still needed from D'Life before launch

Unchanged from the guide's own verification list:
...
6. Licensing status (changes wording on the legal pages)

Preview: https://chewmunkai.github.io/dlife-website/
